 ...
 * @param children 1-D Array of Type TreeNode...for reference to children Nodes
 * @param Edge  Reference to Edge Names     
 * @param ChildCount Stores the number of Child's
 * @param TestingDataSubset StringArray to Store the Testing Data Subset
 * @param feature_id  Stores the Attribute Id or Feature id 
...
public class TreeNode {
	...
	public TreeNode[] children = new TreeNode[13];           // "children" : 1-D array of children
